...
<div class="page-content"> 
    	...
    	<div class="container for-navi">
            ...
            <h1>
                <a href="index.html">
                    ...
                    <span class="logo-text">Adore <span>Church</span></span>
            ...
            <!-- Main Navigation -->
             <nav class="main-navigation" role="navigation">
                <ul class="sf-menu">
                    ...
                    <li><a href="single-sermon.html">Sermons</a></li>
	...
	<!-- End Site Header -->
    <!-- Start Page Header -->
        <div class="page-header parallax clearfix" style="background-image:url(./images/bg1.jpg);">
        	...
        	<div class="container">
                <div class="row">
                	<div class="col-md-4 col-sm-5">
                    	<h2>Contact Us</h2>
                    	<hr class="sm">
                    	<h4 class="short accent-color">Fruitland,Maryland</h4>
                    	<p>777, path to God<br>1800-989-990<br><a href="mailto:us@adorechurch.com">us@Rchurch.com</a></p>
    ...
    <form action="https://formspree.io/dqliles@gmail.com"
        		...
        		<div class="quick-info">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <p>11 - 00 - 653240<br>email@Rchurch.com</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <h4><i class="fa fa-clock-o"></i> Socialize with us</h4>
                            <ul class="social-icons-colored inversed">
                                <li class="facebook"><a href="https://www.facebook.com/groups/1670801793234898/"><i class="fa fa-facebook"></i></a></li>
        		...
        		<div class="site-footer-bottom">
            		<div class="row">
                		<div class="col-md-6 col-sm-6 copyrights-coll">
        					&copy; 2016 R Church. All Rights Reserved
            			</div>
...
<div class="sidebar">
                    ...
                    <li><a href="about.html" class="one">About </a>
...
var address = "305 East Main Street 399 Fruitland, Maryland - 21826 USA"; //Add your address here, all on one line.
var latitude;
var longitude;
